...
struct Plan {
  ...
  // List of identifiers used by this plan. identifiers used by this part of the
  // plan. These can be both identifiers introduced by you, or automatically
  // generated.
  std::vector<std::string> identifiers;
  // Zero or more child plans. A plan is a tree, where each child is another
  // plan. The children are where this part of the plan gets its input records -
  // unless this is an operator that introduces new records on its own.
...
struct ProfiledPlan {
  ...
  // These can be both identifiers introduced by you, or automatically
  // generated.
  std::vector<std::string> identifiers;
  // dbHits contains the number of times this part of the plan touched the
...
struct InputPosition {
  // offset contains the character offset referred to by this position; offset
  // numbers start at 0.
  int offset = 0;
  // line contains the line number referred to by this position; line numbers
  // start at 1.
  int line = 0;
  // column contains the column number referred to by this position; column
  // numbers start at 1.
  int column = 0;
};
