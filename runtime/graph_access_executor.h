...
class GraphAccessExecutor final {
 public:
  explicit GraphAccessExecutor(const GraphReader &graph_reader,
                               ExecutionContext context = {})
      : graph_reader_(&graph_reader), context_(context) {}
 ...
 private:
  ...
  void AddDirectedRelationshipRow(const QueryRow &row,
                                  ...
                                  QueryRows *out) const;
  [[nodiscard]] std::vector<GraphReader::RelationshipPtr> ExpandCandidates(
