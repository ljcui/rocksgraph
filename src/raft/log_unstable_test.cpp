...
TEST(unstable, TestUnstableMaybeFirstIndex) {
  ...
  std::vector<Test> tests = {
      // no snapshot
      {{EntryHelper{.index = 5, .term = 1}.Done()}, 5, nullptr, false, 0},
      {
          {},
          0,
          nullptr,
      ...
      // has snapshot
      {
          ...
          5,
          new raftpb::Snapshot(SnapshotHelper{.index = 4, .term = 1}.Done()),
          true,
          5,
      },
      {
...
TEST(unstable, TestMaybeLastIndex) {
  ...
  std::vector<Test> tests = {
      // last in entries
      {{EntryHelper{.index = 5, .term = 1}.Done()}, 5, nullptr, true, 5},
      {{EntryHelper{.index = 5, .term = 1}.Done()},
       5,
       new raftpb::Snapshot(SnapshotHelper{.index = 4, .term = 1}.Done()),
       true,
...
TEST(unstable, TestUnstableRestore) {
  ...
  u.snapshot_ = std::make_shared<raftpb::Snapshot>(
      SnapshotHelper{.index = 4, .term = 1}.Done());
  ...
  EXPECT_TRUE(
      google::protobuf::util::MessageDifferencer::Equals(s, *u.snapshot_));
...
TEST(unstable, TestUnstableAcceptInProgress) {
  ...
  std::vector<Test> tests = {
      ...
      {
          {},
          std::make_shared<raftpb::Snapshot>(
              SnapshotHelper{.index = 4, .term = 1}.Done()),
          5,      // no entries
          false,  // snapshot not already in progress
          5,
...
TEST(unstable, TestUnstableStableTo) {
  ...
  std::vector<Test> tests = {
      ...
      },
      {
          ...
          7,
          std::make_shared<raftpb::Snapshot>(
              SnapshotHelper{.index = 5, .term = 1}.Done()),
          6,
          1,  // stable to the first entry and term mismatch
          6,
          7,
      ...
      },
      {
          ...
          6,
          std::make_shared<raftpb::Snapshot>(
              SnapshotHelper{.index = 4, .term = 2}.Done()),
          4,
          1,  // stable to old entry
          5,
          6,
...
TEST(unstable, TestUnstableTruncateAndAppend) {
  ...
  std::vector<Test> tests = {
      // append to the end
      {
          ...
          nullptr,
          {EntryHelper{.index = 6, .term = 1}.Done(),
           EntryHelper{.index = 7, .term = 1}.Done()},
          5,
          5,
          {EntryHelper{.index = 5, .term = 1}.Done(),
           EntryHelper{.index = 6, .term = 1}.Done(),
      ...
      },
      {
          ...
          5,
          nullptr,
          {EntryHelper{.index = 7, .term = 2}.Done(),
           EntryHelper{.index = 8, .term = 2}.Done()},
          5,
          5,
          {EntryHelper{.index = 5, .term = 1}.Done(),
           EntryHelper{.index = 6, .term = 1}.Done(),
