...
#define LOG_TRACE(fmt, ...)                                            \
  ...
  spdlog::log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, \
              spdlog::level::level_enum::trace, fmt, ##__VA_ARGS__)

#define LOG_DEBUG(fmt, ...)                                            \
  if (spdlog::should_log(spdlog::level::level_enum::debug))            \
  spdlog::log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, \
              spdlog::level::level_enum::debug, fmt, ##__VA_ARGS__)
...
#define LOG_WARN(fmt, ...)                                             \
  ...
  spdlog::log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, \
              spdlog::level::level_enum::warn, fmt, ##__VA_ARGS__)
...
#define LOG_FATAL(fmt, ...)                                               \
  {                                                                       \
    spdlog::log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION},  \
                spdlog::level::level_enum::critical, fmt, ##__VA_ARGS__); \
