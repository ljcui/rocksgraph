...
class CypherParser : public antlr4::Parser {
 public:
  ...
  enum {
    ...
    RuleOC_Statement = 1,
    RuleOC_Query = 2,
    RuleOC_RegularQuery = 3,
    RuleOC_Union = 4,
    RuleOC_SingleQuery = 5,
    RuleOC_SinglePartQuery = 6,
    RuleOC_MultiPartQuery = 7,
    RuleOC_UpdatingClause = 8,
    RuleOC_ReadingClause = 9,
    RuleOC_Match = 10,
    RuleOC_Unwind = 11,
    RuleOC_Merge = 12,
    RuleOC_MergeAction = 13,
    RuleOC_Create = 14,
    RuleOC_Set = 15,
    RuleOC_SetItem = 16,
    RuleOC_Delete = 17,
    RuleOC_Remove = 18,
    RuleOC_RemoveItem = 19,
    RuleOC_InQueryCall = 20,
    RuleOC_StandaloneCall = 21,
    RuleOC_YieldItems = 22,
    RuleOC_YieldItem = 23,
    RuleOC_With = 24,
    RuleOC_Return = 25,
    RuleOC_ProjectionBody = 26,
    RuleOC_ProjectionItems = 27,
    RuleOC_ProjectionItem = 28,
    RuleOC_Order = 29,
    RuleOC_Skip = 30,
    RuleOC_Limit = 31,
    RuleOC_SortItem = 32,
    RuleOC_Where = 33,
    RuleOC_Pattern = 34,
    RuleOC_PatternPart = 35,
    RuleOC_AnonymousPatternPart = 36,
    RuleOC_PatternElement = 37,
    RuleOC_RelationshipsPattern = 38,
    RuleOC_NodePattern = 39,
    RuleOC_PatternElementChain = 40,
    RuleOC_RelationshipPattern = 41,
    RuleOC_RelationshipDetail = 42,
    RuleOC_Properties = 43,
    RuleOC_RelationshipTypes = 44,
    RuleOC_NodeLabels = 45,
    RuleOC_NodeLabel = 46,
    RuleOC_RangeLiteral = 47,
    RuleOC_LabelName = 48,
    RuleOC_RelTypeName = 49,
    RuleOC_PropertyExpression = 50,
    RuleOC_Expression = 51,
    RuleOC_OrExpression = 52,
    RuleOC_XorExpression = 53,
    RuleOC_AndExpression = 54,
    RuleOC_NotExpression = 55,
    RuleOC_ComparisonExpression = 56,
    RuleOC_PartialComparisonExpression = 57,
    RuleOC_StringListNullPredicateExpression = 58,
    RuleOC_StringPredicateExpression = 59,
    RuleOC_ListPredicateExpression = 60,
    RuleOC_NullPredicateExpression = 61,
    RuleOC_AddOrSubtractExpression = 62,
    RuleOC_MultiplyDivideModuloExpression = 63,
    RuleOC_PowerOfExpression = 64,
    RuleOC_UnaryAddOrSubtractExpression = 65,
    RuleOC_NonArithmeticOperatorExpression = 66,
    RuleOC_ListOperatorExpression = 67,
    RuleOC_PropertyLookup = 68,
    RuleOC_Atom = 69,
    RuleOC_CaseExpression = 70,
    RuleOC_CaseAlternative = 71,
    RuleOC_ListComprehension = 72,
    RuleOC_PatternComprehension = 73,
    RuleOC_Quantifier = 74,
    RuleOC_FilterExpression = 75,
    RuleOC_PatternPredicate = 76,
    RuleOC_ParenthesizedExpression = 77,
    RuleOC_IdInColl = 78,
    RuleOC_FunctionInvocation = 79,
    RuleOC_FunctionName = 80,
    RuleOC_ExistentialSubquery = 81,
    RuleOC_ExplicitProcedureInvocation = 82,
    RuleOC_ImplicitProcedureInvocation = 83,
    RuleOC_ProcedureResultField = 84,
    RuleOC_ProcedureName = 85,
    RuleOC_Namespace = 86,
    RuleOC_Variable = 87,
    RuleOC_Literal = 88,
    RuleOC_BooleanLiteral = 89,
    RuleOC_NumberLiteral = 90,
    RuleOC_IntegerLiteral = 91,
    RuleOC_DoubleLiteral = 92,
    RuleOC_ListLiteral = 93,
    RuleOC_MapLiteral = 94,
    RuleOC_PropertyKeyName = 95,
    RuleOC_Parameter = 96,
    RuleOC_SchemaName = 97,
    RuleOC_ReservedWord = 98,
    RuleOC_SymbolicName = 99,
    RuleOC_LeftArrowHead = 100,
    RuleOC_RightArrowHead = 101,
    RuleOC_Dash = 102
  };
  ...
  class OC_RemoveItemContext : public antlr4::ParserRuleContext {
   public:
    OC_RemoveItemContext(antlr4::ParserRuleContext *parent,
                         size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_VariableContext *oC_Variable();
    OC_NodeLabelsContext *oC_NodeLabels();
  ...
  class OC_InQueryCallContext : public antlr4::ParserRuleContext {
   public:
    OC_InQueryCallContext(antlr4::ParserRuleContext *parent,
                          size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class OC_StandaloneCallContext : public antlr4::ParserRuleContext {
   public:
    OC_StandaloneCallContext(antlr4::ParserRuleContext *parent,
                             size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *CALL();
    std::vector<antlr4::tree::TerminalNode *> SP();
  ...
  class OC_RelationshipsPatternContext : public antlr4::ParserRuleContext {
   public:
    OC_RelationshipsPatternContext(antlr4::ParserRuleContext *parent,
                                   size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_NodePatternContext *oC_NodePattern();
    std::vector<OC_PatternElementChainContext *> oC_PatternElementChain();
  ...
  class OC_PropertiesContext : public antlr4::ParserRuleContext {
   public:
    OC_PropertiesContext(antlr4::ParserRuleContext *parent,
                         size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class OC_ComparisonExpressionContext : public antlr4::ParserRuleContext {
   public:
    ...
    std::vector<OC_PartialComparisonExpressionContext *>
  ...
  class OC_PartialComparisonExpressionContext
   ...
   public:
    OC_PartialComparisonExpressionContext(antlr4::ParserRuleContext *parent,
                                          size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_StringListNullPredicateExpressionContext *
    oC_StringListNullPredicateExpression();
  ...
  class OC_StringPredicateExpressionContext : public antlr4::ParserRuleContext {
   public:
    OC_StringPredicateExpressionContext(antlr4::ParserRuleContext *parent,
                                        size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_AddOrSubtractExpressionContext *oC_AddOrSubtractExpression();
    std::vector<antlr4::tree::TerminalNode *> SP();
  ...
  class OC_ListPredicateExpressionContext : public antlr4::ParserRuleContext {
   public:
    OC_ListPredicateExpressionContext(antlr4::ParserRuleContext *parent,
                                      size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> SP();
    antlr4::tree::TerminalNode *SP(size_t i);
  ...
  class OC_NullPredicateExpressionContext : public antlr4::ParserRuleContext {
   public:
    OC_NullPredicateExpressionContext(antlr4::ParserRuleContext *parent,
                                      size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> SP();
    antlr4::tree::TerminalNode *SP(size_t i);
  ...
  class OC_PowerOfExpressionContext : public antlr4::ParserRuleContext {
   public:
    OC_PowerOfExpressionContext(antlr4::ParserRuleContext *parent,
                                size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<OC_UnaryAddOrSubtractExpressionContext *>
  ...
  class OC_UnaryAddOrSubtractExpressionContext
      : public antlr4::ParserRuleContext {
   public:
    OC_UnaryAddOrSubtractExpressionContext(antlr4::ParserRuleContext *parent,
                                           size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class OC_NonArithmeticOperatorExpressionContext
      : public antlr4::ParserRuleContext {
   public:
    OC_NonArithmeticOperatorExpressionContext(antlr4::ParserRuleContext *parent,
                                              size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_AtomContext *oC_Atom();
    OC_NodeLabelsContext *oC_NodeLabels();
  ...
  class OC_ListComprehensionContext : public antlr4::ParserRuleContext {
   public:
    OC_ListComprehensionContext(antlr4::ParserRuleContext *parent,
                                size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class OC_PatternComprehensionContext : public antlr4::ParserRuleContext {
   public:
    OC_PatternComprehensionContext(antlr4::ParserRuleContext *parent,
                                   size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_RelationshipsPatternContext *oC_RelationshipsPattern();
    OC_ExpressionContext *oC_Expression();
  ...
  class OC_PatternPredicateContext : public antlr4::ParserRuleContext {
   public:
    OC_PatternPredicateContext(antlr4::ParserRuleContext *parent,
                               size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_RelationshipsPatternContext *oC_RelationshipsPattern();
  ...
  class OC_ExistentialSubqueryContext : public antlr4::ParserRuleContext {
   public:
    OC_ExistentialSubqueryContext(antlr4::ParserRuleContext *parent,
                                  size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class OC_ExplicitProcedureInvocationContext
      : public antlr4::ParserRuleContext {
   public:
    OC_ExplicitProcedureInvocationContext(antlr4::ParserRuleContext *parent,
                                          size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class OC_ImplicitProcedureInvocationContext
      : public antlr4::ParserRuleContext {
   public:
    OC_ImplicitProcedureInvocationContext(antlr4::ParserRuleContext *parent,
                                          size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_ProcedureNameContext *oC_ProcedureName();
  ...
  class OC_ProcedureResultFieldContext : public antlr4::ParserRuleContext {
   public:
    OC_ProcedureResultFieldContext(antlr4::ParserRuleContext *parent,
                                   size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_SymbolicNameContext *oC_SymbolicName();
  ...
  class OC_ProcedureNameContext : public antlr4::ParserRuleContext {
   public:
    OC_ProcedureNameContext(antlr4::ParserRuleContext *parent,
                            size_t invokingState);
    virtual size_t getRuleIndex() const override;
    OC_NamespaceContext *oC_Namespace();
    OC_SymbolicNameContext *oC_SymbolicName();
  ...
  class OC_NamespaceContext : public antlr4::ParserRuleContext {
   public:
    OC_NamespaceContext(antlr4::ParserRuleContext *parent,
                        size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class OC_MapLiteralContext : public antlr4::ParserRuleContext {
   public:
    OC_MapLiteralContext(antlr4::ParserRuleContext *parent,
                         size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> SP();
    antlr4::tree::TerminalNode *SP(size_t i);
  ...
  class OC_ReservedWordContext : public antlr4::ParserRuleContext {
   public:
    OC_ReservedWordContext(antlr4::ParserRuleContext *parent,
                           size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ALL();
    antlr4::tree::TerminalNode *ASC();
