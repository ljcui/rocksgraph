...
TEST(LocalDateTime, localDateTimeFromMap) {
  ...
  EXPECT_EQ(common::LocalDateTime(Value::Map({{"dayOfWeek", Value::Integer(2)},
  ...
  EXPECT_EQ(
      common::LocalDateTime(Value({{"date", Value(common::Date("1816-12-30"))},
                                   {"week", Value((int64_t)2)},
                                   {"dayOfWeek", Value((int64_t)3)}}))
          .ToString(),
  ...
  EXPECT_EQ(
      common::LocalDateTime(Value({{"date", Value(common::Date("1816-12-31"))},
                                   {"week", Value((int64_t)2)}}))
          .ToString(),
...
TEST(LocalTime, timeFromMap) {
  EXPECT_EQ(
      common::LocalTime(Value::Map({{"hour", Value::Integer(12)},
                                    {"minute", Value::Integer(31)},
                                    {"second", Value::Integer(14)},
                                    {"nanosecond", Value::Integer(789)},
                                    {"millisecond", Value::Integer(123)},
  ...
  EXPECT_EQ(
      common::LocalTime(Value::Map({{"hour", Value::Integer(12)},
          ...
          .ToString(),
      "12:31:14.645000000");
  EXPECT_EQ(common::LocalTime(Value::Map({{"hour", Value::Integer(12)},
                                          {"minute", Value::Integer(31)},
                                          {"second", Value::Integer(14)}}))
                .ToString(),
            "12:31:14.000000000");
  EXPECT_EQ(common::LocalTime(Value::Map({{"hour", Value::Integer(12)},
            ...
            "12:31:00.000000000");
  EXPECT_EQ(
      common::LocalTime(Value::Map({{"hour", Value::Integer(12)}})).ToString(),
      "12:00:00.000000000");
  EXPECT_EQ(
      common::LocalTime(Value::LocalTime(common::LocalTime(Value::Map(
                            {{"hour", Value::Integer(12)},
                             {"minute", Value::Integer(31)},
                             {"second", Value::Integer(14)},
                             {"nanosecond", Value::Integer(645876123)}}))))
  ...
  EXPECT_EQ(
      common::LocalTime(
          Value::Map(
              {{"time", Value::LocalTime(common::LocalTime(Value::Map(
                            {{"hour", Value::Integer(12)},
                             {"minute", Value::Integer(31)},
                             {"second", Value::Integer(14)},
                             {"nanosecond", Value::Integer(645876123)}})))}}))
  ...
  EXPECT_EQ(
      common::LocalTime(
          ...
          .ToString(),
      "12:31:42.645876123");
  EXPECT_TRUE(common::LocalTime(Value::Map({{"hour", Value::Integer(10)},
                                            {"minute", Value::Integer(35)}})) <
              common::LocalTime(
                  Value::Map({{"hour", Value::Integer(12)},
                              {"minute", Value::Integer(31)},
                              {"second", Value::Integer(14)},
                              {"nanosecond", Value::Integer(645876123)}})));
  EXPECT_TRUE(common::LocalTime(
                  Value::Map({{"hour", Value::Integer(12)},
                              {"minute", Value::Integer(31)},
                              {"second", Value::Integer(14)},
                              {"nanosecond", Value::Integer(645876123)}})) ==
...
TEST(Time, timeFromString) {
  EXPECT_EQ(common::Time("21:40:32.142+0100").ToString(),
            "21:40:32.142000000+01:00:00");
  EXPECT_EQ(common::Time("214032.142Z").ToString(), "21:40:32.142000000Z");
  EXPECT_EQ(common::Time("21:40:32+01:00").ToString(),
            "21:40:32.000000000+01:00:00");
  EXPECT_EQ(common::Time("214032-0100").ToString(),
            "21:40:32.000000000-01:00:00");
  EXPECT_EQ(common::Time("21:40-01:30").ToString(),
            "21:40:00.000000000-01:30:00");
...
TEST(Time, timeFromMap) {
  EXPECT_EQ(common::Time(Value::Map({{"hour", Value::Integer(12)},
                                     {"minute", Value::Integer(31)},
                                     {"second", Value::Integer(14)},
                                     {"nanosecond", Value::Integer(789)},
                                     {"millisecond", Value::Integer(123)},
            ...
            "12:31:14.123456789Z");
  EXPECT_EQ(
      common::Time(Value::Map({{"hour", Value::Integer(12)},
                               {"minute", Value::Integer(31)},
                               {"second", Value::Integer(14)},
                               {"nanosecond", Value::Integer(645876123)}}))
          .ToString(),
...
TEST(Time, localtimeNestedMap) {
  EXPECT_EQ(common::LocalTime(Value::Time(common::Time(Value::Map(
                                  {{"hour", Value::Integer(12)},
                                   {"minute", Value::Integer(31)},
                                   {"second", Value::Integer(14)},
                                   {"microsecond", Value::Integer(645876)},
                ...
                .ToString(),
            "12:31:14.645876000");
  EXPECT_EQ(common::LocalTime(
                Value::Map(
                    {{"time", Value::Time(common::Time(Value::Map(
                                  {{"hour", Value::Integer(12)},
                                   {"minute", Value::Integer(31)},
                                   {"second", Value::Integer(14)},
                                   {"microsecond", Value::Integer(645876)},
  ...
  EXPECT_EQ(
      common::LocalTime(
          Value::Map({{"time", Value::Time(common::Time(Value::Map(
                                   {{"hour", Value::Integer(12)},
                                    {"minute", Value::Integer(31)},
                                    {"second", Value::Integer(14)},
                                    {"microsecond", Value::Integer(645876)},
          ...
          .ToString(),
      "12:31:42.645876000");
  EXPECT_EQ(common::Time(Value::LocalTime(common::LocalTime(Value::Map(
                             {{"hour", Value::Integer(12)},
                              {"minute", Value::Integer(31)},
                              {"second", Value::Integer(14)},
                              {"nanosecond", Value::Integer(645876123)}}))))
  ...
  EXPECT_EQ(common::Time(Value::Time(common::Time(Value::Map(
                             {{"hour", Value::Integer(12)},
                              {"minute", Value::Integer(31)},
                              {"second", Value::Integer(14)},
                              {"microsecond", Value::Integer(645876)},
...
TEST(Time, localdatetimeNestedMap) {
  EXPECT_EQ(
      common::LocalTime(Value::LocalDateTime(common::LocalDateTime(Value::Map(
  ...
  EXPECT_EQ(
      common::LocalTime(
          Value::Map(
              {{"time", Value::LocalDateTime(common::LocalDateTime(Value::Map(
                            {{"year", Value::Integer(1984)},
                             {"week", Value::Integer(10)},
                             {"dayOfWeek", Value::Integer(3)},
                             {"hour", Value::Integer(12)},
  ...
  EXPECT_EQ(common::LocalTime(
                Value::Map(
                    {{"time", Value::DateTime(common::DateTime(Value::Map(
                                  {{"year", Value::Integer(1984)},
                                   {"month", Value::Integer(10)},
                                   {"day", Value::Integer(11)},
                                   {"hour", Value::Integer(12)},
  ...
  EXPECT_EQ(
      common::LocalTime(
          Value::Map({{"time", Value::DateTime(common::DateTime(Value::Map(
                                   {{"year", Value::Integer(1984)},
                                    {"month", Value::Integer(10)},
                                    {"day", Value::Integer(11)},
                                    {"hour", Value::Integer(12)},
  ...
  EXPECT_EQ(
      common::Time(Value::DateTime(common::DateTime(Value::Map(
                       {{"year", Value::Integer(1984)},
                        {"month", Value::Integer(10)},
                        {"day", Value::Integer(11)},
                        {"hour", Value::Integer(12)},
...
TEST(Duration, fromMap) {
  EXPECT_EQ(common::Duration(Value({{"days", Value::Integer(14)},
                                    {"hours", Value::Integer(16)},
                                    {"minutes", Value::Integer(12)}}))
                .ToString(),
            "P14DT16H12M");
  EXPECT_EQ(common::Duration(Value({{"months", Value::Integer(5)},
                                    {"days", Value::Double(1.5)}}))
                .ToString(),
            "P5M1DT12H");
  EXPECT_EQ(
      common::Duration(Value({{"months", Value::Double(0.75)}})).ToString(),
      "P22DT19H51M49.5S");
  EXPECT_EQ(common::Duration(Value({{"weeks", Value::Double(2.5)}})).ToString(),
            "P17DT12H");
  EXPECT_EQ(common::Duration(Value({{"years", Value::Integer(12)},
                                    {"months", Value::Integer(5)},
                                    {"days", Value::Integer(14)},
                                    {"hours", Value::Integer(16)},
                                    {"minutes", Value::Integer(12)},
                                    {"seconds", Value::Integer(70)}}))
                .ToString(),
            "P12Y5M14DT16H13M10S");
  EXPECT_EQ(common::Duration(Value({{"days", Value::Integer(14)},
                                    {"seconds", Value::Integer(70)},
                                    {"milliseconds", Value::Integer(1)}}))
                .ToString(),
            "P14DT1M10.001S");
  EXPECT_EQ(common::Duration(Value({{"days", Value::Integer(14)},
                                    {"seconds", Value::Integer(70)},
                                    {"microseconds", Value::Integer(1)}}))
                .ToString(),
            "P14DT1M10.000001S");
  EXPECT_EQ(common::Duration(Value({{"days", Value::Integer(14)},
                                    {"seconds", Value::Integer(70)},
                                    {"nanoseconds", Value::Integer(1)}}))
                .ToString(),
            "P14DT1M10.000000001S");
  EXPECT_EQ(common::Duration(Value({{"minutes", Value::Double(1.5)},
                                    {"seconds", Value::Integer(1)}}))
                .ToString(),
            "PT1M31S");
}
...
TEST(Duration, durationFromString) {
  ...
  EXPECT_EQ(common::Duration("P12Y5M14DT16H12M70S").ToString(),
            "P12Y5M14DT16H13M10S");
  EXPECT_EQ(common::Duration("P2012-02-02T14:37:21.545").ToString(),
            "P2012Y2M2DT14H37M21.545S");
}

TEST(Duration, between) {
  EXPECT_EQ(common::Duration::between(
                Value::LocalDateTime(common::LocalDateTime("2018-01-01T12:00")),
                Value::LocalDateTime(common::LocalDateTime("2018-01-02T10:00")))
                .ToString(),
            "PT22H");
  EXPECT_EQ(common::Duration::between(
                Value::LocalDateTime(common::LocalDateTime("2018-01-02T10:00")),
            ...
            "PT-22H");
  EXPECT_EQ(
      common::Duration::between(
          Value::LocalDateTime(common::LocalDateTime("2018-01-01T10:00:00.2")),
          Value::LocalDateTime(common::LocalDateTime("2018-01-02T10:00:00.1")))
          .ToString(),
      "PT23H59M59.9S");
  EXPECT_EQ(
      common::Duration::between(
      ...
      "PT-23H-59M-59.9S");
  EXPECT_EQ(common::Duration::between(
                Value::DateTime(common::DateTime("2017-10-28T23:00+02:00")),
                Value::DateTime(common::DateTime("2017-10-29T04:00+01:00")))
                .ToString(),
            "PT6H");
  EXPECT_EQ(common::Duration::between(
                Value::DateTime(common::DateTime("2017-10-29T04:00+01:00")),
  ...
  EXPECT_EQ(common::Duration::between(Value::Date(common::Date("1984-10-11")),
                                      Value::Date(common::Date("2015-06-24")))
                .ToString(),
            "P30Y8M13D");
  EXPECT_EQ(
      common::Duration::between(Value::Date(common::Date("1984-10-11")),
                                Value::LocalDateTime(common::LocalDateTime(
                                    "2016-07-21T21:45:22.142")))
          .ToString(),
      "P31Y9M10DT21H45M22.142S");
  EXPECT_EQ(
      common::Duration::between(
          Value::Date(common::Date("1984-10-11")),
          Value::DateTime(common::DateTime("2015-07-21T21:40:32.142+0100")))
          .ToString(),
      "P30Y9M10DT21H40M32.142S");
  EXPECT_EQ(
      common::Duration::between(Value::Date(common::Date("1984-10-11")),
                                Value::LocalTime(common::LocalTime("16:30")))
          .ToString(),
      "PT16H30M");
  EXPECT_EQ(common::Duration::between(Value::Date(common::Date("1984-10-11")),
                                      Value::Time(common::Time("16:30+0100")))
                .ToString(),
            "PT16H30M");
  EXPECT_EQ(
      common::Duration::between(Value::LocalTime(common::LocalTime("14:30")),
                                Value::Date(common::Date("2015-06-24")))
          .ToString(),
      "PT-14H-30M");
  EXPECT_EQ(
  ...
  EXPECT_EQ(
      common::Duration::between(
          Value::LocalTime(common::LocalTime("14:30")),
          Value::DateTime(common::DateTime("2015-07-21T21:40:32.142+0100")))
          .ToString(),
      "PT7H10M32.142S");
  EXPECT_EQ(
  ...
  EXPECT_EQ(common::Duration::between(Value::Time(common::Time("14:30")),
            ...
            "PT-14H-30M");
  EXPECT_EQ(
      common::Duration::between(Value::Time(common::Time("14:30")),
                                Value::LocalDateTime(common::LocalDateTime(
                                    "2016-07-21T21:45:22.142")))
          .ToString(),
      "PT7H15M22.142S");
  ...
  EXPECT_EQ(common::Duration::between(Value::Time(common::Time("14:30")),
            ...
            "PT1H");
  EXPECT_EQ(
      common::Duration::between(Value::LocalDateTime(common::LocalDateTime(
  ...
  EXPECT_EQ(common::Duration::between(
                Value::LocalDateTime(
                    common::LocalDateTime("2015-07-21T21:40:32.142")),
                Value::LocalDateTime(
                    common::LocalDateTime("2016-07-21T21:45:22.142")))
                .ToString(),
            "P1YT4M50S");
  EXPECT_EQ(
      common::Duration::between(
  ...
  EXPECT_EQ(
      common::Duration::between(
          Value::DateTime(common::DateTime("2014-07-21T21:40:36.143+0200")),
          Value::Date(common::Date("2015-06-24")))
          .ToString(),
      "P11M2DT2H19M23.857S");
  EXPECT_EQ(
  ...
  //                                        Value::Date(common::Date("+999999999-12-31"))).ToString(),
  //                                        "P1999999998Y11M30D");
}
...
TEST(Duration, betweenFunction) {
  ...
  EXPECT_EQ(common::Duration::between(
                Value::Date(common::Date("1984-10-11")),
                Value::LocalTime(common::LocalTime("16:30")), "MONTH")
                .ToString(),
            "PT0S");
  EXPECT_EQ(common::Duration::between(Value::Date(common::Date("1984-10-11")),
                                      Value::Time(common::Time("16:30+0100")),
  ...
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("14:30")),
                Value::Date(common::Date("2015-06-24")), "MONTH")
                .ToString(),
            "PT0S");
  EXPECT_EQ(
      common::Duration::between(Value::LocalTime(common::LocalTime("14:30")),
  ...
  EXPECT_EQ(common::Duration::between(
                Value::LocalDateTime(
                    common::LocalDateTime("2015-07-21T21:40:32.142")),
                Value::Time(common::Time("16:30+0100")), "MONTH")
                .ToString(),
            "PT0S");
  EXPECT_EQ(
      common::Duration::between(
  ...
  EXPECT_EQ(
      common::Duration::between(Value::Date(common::Date("1984-10-11")),
                                Value::Date(common::Date("2015-06-24")), "DAY")
          .ToString(),
      "P11213D");
  EXPECT_EQ(
      common::Duration::between(Value::Date(common::Date("1984-10-11")),
  ...
  EXPECT_EQ(common::Duration::between(
                Value::Date(common::Date("1984-10-11")),
                Value::LocalTime(common::LocalTime("16:30")), "DAY")
                .ToString(),
            "PT0S");
  EXPECT_EQ(
      common::Duration::between(Value::Date(common::Date("1984-10-11")),
                                Value::Time(common::Time("16:30+0100")), "DAY")
          .ToString(),
      "PT0S");
  EXPECT_EQ(
      common::Duration::between(Value::LocalTime(common::LocalTime("14:30")),
  ...
  EXPECT_EQ(common::Duration::between(
                Value::Date(common::Date("1984-10-11")),
                Value::LocalTime(common::LocalTime("16:30")), "SECOND")
                .ToString(),
            "PT16H30M");
  EXPECT_EQ(common::Duration::between(Value::Date(common::Date("1984-10-11")),
                                      Value::Time(common::Time("16:30+0100")),
  ...
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("14:30")),
                Value::Date(common::Date("2015-06-24")), "SECOND")
                .ToString(),
            "PT-14H-30M");
  EXPECT_EQ(
      common::Duration::between(Value::LocalTime(common::LocalTime("14:30")),
  ...
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("14:30")),
                Value::Time(common::Time("16:30+0100")), "SECOND")
                .ToString(),
            "PT2H");
  EXPECT_EQ(common::Duration::between(Value::Time(common::Time("14:30")),
                                      Value::Date(common::Date("2015-06-24")),
  ...
  EXPECT_EQ(common::Duration::between(
                Value::LocalDateTime(
                    common::LocalDateTime("2014-07-21T21:40:36.143")),
                Value::LocalDateTime(
                    common::LocalDateTime("2014-07-21T21:40:36.142")),
                "SECOND")
                .ToString(),
            "PT-0.001S");
  EXPECT_EQ(common::Duration::between(Value::Date(common::Date("2018-03-11")),
                                      Value::Date(common::Date("2016-06-24")),
                                      "MONTH")
                .ToString(),
            "P-1Y-8M");
  EXPECT_EQ(
      common::Duration::between(
          Value::Date(common::Date("2018-07-21")),
          Value::DateTime(common::DateTime("2016-07-21T21:40:32.142+0100")),
          "MONTH")
          .ToString(),
      "P-1Y-11M");
  EXPECT_EQ(common::Duration::between(
                Value::LocalDateTime(
                    common::LocalDateTime("2018-07-21T21:40:32.142")),
                Value::Date(common::Date("2016-07-21")), "MONTH")
                .ToString(),
            "P-2Y");
  EXPECT_EQ(
      common::Duration::between(
          Value::DateTime(common::DateTime("2018-07-21T21:40:36.143+0200")),
          Value::LocalDateTime(
              common::LocalDateTime("2016-07-21T21:40:36.143")),
          "MONTH")
          .ToString(),
      "P-2Y");
  EXPECT_EQ(
      common::Duration::between(
          Value::DateTime(common::DateTime("2018-07-21T21:40:36.143+0500")),
          Value::DateTime(common::DateTime("1984-07-21T22:40:36.143+0200")),
          "MONTH")
          .ToString(),
      "P-33Y-11M");
  EXPECT_EQ(common::Duration::between(
  ...
  EXPECT_EQ(common::Duration::between(
                Value::LocalDateTime(common::LocalDateTime(
                    Value::Map({{"year", Value::Integer(2017)},
                                {"month", Value::Integer(10)},
                                {"day", Value::Integer(29)},
                                {"hour", Value::Integer(0)}}))),
                Value::DateTime(common::DateTime(Value::Map(
            ...
            "PT4H");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime(
                    Value::Map({{"hour", Value::Integer(0)}}))),
                Value::DateTime(common::DateTime(Value::Map(
                    {{"year", Value::Integer(2017)},
                     {"month", Value::Integer(10)},
                     {"day", Value::Integer(29)},
  ...
  EXPECT_EQ(
      common::Duration::between(
          Value::Date(common::Date(Value::Map({{"year", Value::Integer(2017)},
                                               {"month", Value::Integer(10)},
                                               {"day", Value::Integer(29)}}))),
          Value::DateTime(common::DateTime(
              Value::Map({{"year", Value::Integer(2017)},
                          {"month", Value::Integer(10)},
                          {"day", Value::Integer(29)},
                          {"hour", Value::Integer(4)},
  ...
  EXPECT_EQ(
      ...
      "PT24H");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:34:54.7")),
                Value::LocalTime(common::LocalTime("12:34:54.3")), "SECOND")
                .ToString(),
            "PT-0.4S");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:34:54.3")),
                Value::LocalTime(common::LocalTime("12:34:54.7")), "SECOND")
                .ToString(),
            "PT0.4S");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:34:54.7")),
                Value::LocalTime(common::LocalTime("12:34:55.3")), "SECOND")
                .ToString(),
            "PT0.6S");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:34:54.7")),
                Value::LocalTime(common::LocalTime("12:44:55.3")), "SECOND")
                .ToString(),
            "PT10M0.6S");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:44:54.7")),
                Value::LocalTime(common::LocalTime("12:34:55.3")), "SECOND")
                .ToString(),
            "PT-9M-59.4S");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:34:56")),
                Value::LocalTime(common::LocalTime("12:34:55.7")), "SECOND")
                .ToString(),
            "PT-0.3S");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:34:56")),
                Value::LocalTime(common::LocalTime("12:44:55.7")), "SECOND")
                .ToString(),
            "PT9M59.7S");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:44:56")),
                Value::LocalTime(common::LocalTime("12:34:55.7")), "SECOND")
                .ToString(),
            "PT-10M-0.3S");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:34:56.3")),
                Value::LocalTime(common::LocalTime("12:34:54.7")), "SECOND")
                .ToString(),
            "PT-1.6S");
  EXPECT_EQ(common::Duration::between(
                Value::LocalTime(common::LocalTime("12:34:54.7")),
                Value::LocalTime(common::LocalTime("12:34:56.3")), "SECOND")
                .ToString(),
            "PT1.6S");
  //    EXPECT_EQ(common::Duration::between(Value::LocalTime(common::LocalTime()),
  //                                        Value::LocalTime(common::LocalTime()),
  //                                        "SECOND").ToString(), "PT0S");
  //    EXPECT_EQ(common::Duration::between(Value::Time(common::Time()),
  //                                        Value::Time(common::Time()),
  //                                        "SECOND").ToString(), "PT0S");
  //    EXPECT_EQ(common::Duration::between(Value::Date(common::Date()),
  //                                        Value::Date(common::Date()),
  //                                        "SECOND").ToString(), "PT0S");
