...
TEST(CostModelTest, UsesDefaultHeuristicStatistics) {
  ...
  planner::CostEstimate unique_node_index_seek =
  ...
  planner::CostEstimate node_index_range =
  ...
  planner::CostEstimate relationship_type_scan =
  ...
  planner::CostEstimate relationship_index_seek =
  ...
  planner::CostEstimate unique_relationship_index_seek =
  ...
  planner::CostEstimate relationship_index_range =
  ...
  planner::CostEstimate untyped_expand =
  ...
  planner::CostEstimate typed_expand =
  ...
  planner::CostEstimate untyped_expand_into =
  ...
  planner::CostEstimate typed_expand_into = model.EstimateExpandInto(
  ...
  planner::CostEstimate value_join =
  ...
  planner::CostEstimate predicate_join =
...
TEST(CostModelTest, UsesInjectedPlannerStatistics) {
  ...
  planner::CostModel model(&statistics);
...
TEST(CostModelTest, UsesHistogramDistinctValuesForEqualitySelectivity) {
  ...
  statistics.node_property_histogram =
      planner::PropertyHistogram{.total_rows = 1000.0, .distinct_values = 20.0};
  statistics.relationship_property_histogram = planner::PropertyHistogram{
      .total_rows = 5000.0, .distinct_values = 100.0};
  planner::CostModel model(&statistics);
...
TEST(CostModelTest, AppliesFilterEstimatesRepeatedly) {
  ...
  planner::CostEstimate estimate = planner::ApplyFilterEstimates(
